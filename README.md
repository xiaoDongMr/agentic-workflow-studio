...
![Agentic Workflow Studio overview](docs/assets/overview.gif)

### Workflow Building

| 工作流列表 | 自动生成工作流 | 可视化编排画布 |
| --- | --- | --- |
| <img src="docs/assets/workflow-list.png" alt="Workflow list" width="100%" /> | <img src="docs/assets/workflow-generation.gif" alt="Workflow generation" width="100%" /> | <img src="docs/assets/workflow-canvas.png" alt="Workflow canvas" width="100%" /> |

| 节点配置 | 单节点调试 | 工作流编排运行 |
| --- | --- | --- |
| <img src="docs/assets/node-configs.png" alt="Node configs" width="100%" /> | <img src="docs/assets/node-debug.gif" alt="Node debug" width="100%" /> | <img src="docs/assets/workflow-run.gif" alt="Workflow run" width="100%" /> |

### Sandbox & Runtime

| 沙箱绑定 | 进入沙箱 | 会话历史恢复 |
| --- | --- | --- |
| <img src="docs/assets/sandbox-binding.png" alt="Sandbox binding" width="100%" /> | <img src="docs/assets/sandbox-enter.gif" alt="Enter sandbox" width="100%" /> | <img src="docs/assets/thread-history.png" alt="Thread history" width="100%" /> |
...
| 2 | 自动生成工作流 | `docs/assets/workflow-generation.gif` | GIF | 展示用户输入自然语言需求后，Workflow Agent 自动生成工作流图。 |
...
| 5 | 单节点调试 | `docs/assets/node-debug.gif` | GIF | 展示单独运行节点、查看输入输出、错误信息和调试结果。 |
| 6 | 沙箱绑定 | `docs/assets/sandbox-binding.png` | Screenshot | 展示工作流绑定沙箱实例，为代码节点提供隔离执行环境。 |
| 7 | 进入沙箱 | `docs/assets/sandbox-enter.gif` | GIF | 展示从工作台进入 aio-sandbox，查看文件环境、运行页面或调试页面。 |
| 8 | 工作流编排运行 | `docs/assets/workflow-run.gif` | GIF | 展示完整工作流运行过程、节点状态流转、流式反馈和最终输出。 |
...
| 12 | 项目总览动图 | `docs/assets/overview.gif` | GIF | 用 1 分钟以内串联工作流创建、AI 生成、调试、沙箱执行和运行结果。 |
